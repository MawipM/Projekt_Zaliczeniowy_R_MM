...
```{r Wykres 1: Histogram spalania, message=FALSE, warning=FALSE}
...
```{r Wykers 2: Liczebność klas samochodów, message=FALSE, warning=FALSE}
...
```{r Wykres 3: Zależność pojemności silnika od klasy}
